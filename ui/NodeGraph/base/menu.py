...
from Dewins.ui.NodeGraph.errors import NodeMenuError
from Dewins.ui.NodeGraph.widgets.actions import BaseMenu, GraphAction, NodeAction
...
class NodeGraphMenu(object):
    ...
    @staticmethod
    def _set_shortcut(action: GraphAction, shortcut):
