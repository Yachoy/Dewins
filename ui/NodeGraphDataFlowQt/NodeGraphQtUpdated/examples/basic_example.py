...
from Dewins.ui.NodeGraphDataFlowQt.NodeGraphQtUpdated import (
    DUNodeGraph,
    DUNodeViewer
)
...
from NodeGraphQt import (
    ...
    PropertiesBinWidget,
    NodesTreeWidget,
    NodesPaletteWidget, GroupNode,
)

# import example nodes from the "nodes" sub-package
from Dewins.ui.NodeGraphDataFlowQt.NodeGraphQtUpdated.examples.nodes import basic_nodes, custom_ports_node, group_node, widget_nodes
...
def main():
    ...
    viewer = DUNodeViewer(undo_stack=undo_stack)
    # create graph controller.
    graph = DUNodeGraph(viewer=viewer, undo_stack=undo_stack)
    ...
    # create group node.
    n_group: GroupNode = graph.create_node('nodes.group.MyGroupNode')
